...
${OBJECTDIR}/jacobi.o: jacobi.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jacobi.o jacobi.cpp
...
${OBJECTDIR}/solve.o: solve.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/solve.o solve.cpp
...
${TESTDIR}/tests/FindRoot.o: tests/FindRoot.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FindRoot.o tests/FindRoot.cpp


${TESTDIR}/tests/rootTestRunner.o: tests/rootTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/rootTestRunner.o tests/rootTestRunner.cpp


${TESTDIR}/tests/GetJacobian.o: tests/GetJacobian.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GetJacobian.o tests/GetJacobian.cpp


${TESTDIR}/tests/jacobiTestRunner.o: tests/jacobiTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/jacobiTestRunner.o tests/jacobiTestRunner.cpp


${TESTDIR}/tests/Solve.o: tests/Solve.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Solve.o tests/Solve.cpp


${TESTDIR}/tests/solveTestRunner.o: tests/solveTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/solveTestRunner.o tests/solveTestRunner.cpp
...
${OBJECTDIR}/jacobi_nomain.o: ${OBJECTDIR}/jacobi.o jacobi.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jacobi_nomain.o jacobi.cpp;\
	else  \
...
${OBJECTDIR}/root_nomain.o: ${OBJECTDIR}/root.o root.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/root_nomain.o root.cpp;\
	else  \
...
${OBJECTDIR}/solve_nomain.o: ${OBJECTDIR}/solve.o solve.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/solve_nomain.o solve.cpp;\
	else  \
